...
export type ProcessTodosProgressInput = {}
export type ProcessTodosProgressOutput = {
...
export type TodoStreamInput = {
    /** User ID (uses demo user if not provided) */
    userId?: (string | null) | undefined;
}
export type TodoStreamOutput = {
    todos: {
        id: string;
        userId: string;
        title: string;
...
export type RPCMap = {
  ...
  readonly 'processTodosProgress': RPCHandler<ProcessTodosProgressInput, ProcessTodosProgressOutput>,
  readonly 'todoStream': RPCHandler<TodoStreamInput, TodoStreamOutput>,
